...
wget -qO- >> /dev/null http://wifirst.net/ \
...
COOKIE=$(wget -qO- https://wireless.wifirst.net/index.txt)
...
BODYDATA2="username=$USERNAME&password=$PASSWORD&success_url=https%3A%2F%2Fwww.myresidhome.com&error_url=https%3A%2F%2Fportal-front.wifirst.net%2Fconnect-error&update_session=0"
